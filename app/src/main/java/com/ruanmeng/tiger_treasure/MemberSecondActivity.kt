...
import kotlinx.android.synthetic.main.activity_member_second.*
import net.idik.lib.slimadapter.SlimAdapter
import java.util.*

class MemberSecondActivity : BaseActivity() {
    private val list_manager = ArrayList<CommonData>()
    private var companyId: String = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_member_second)
        init_title("采购详情", "联系企业")
    ...
    override fun doClick(v: View) {
        super.doClick(v)
        when (v.id) {
            R.id.li_seconed_company -> {
                val intent = Intent(this@MemberSecondActivity, EnterpriseDetailActivity::class.java)
        ...
        OkGo.post<BaseResponse<PurchaseData>>(BaseHttp.purchasing_details)
                ...
                .execute(object : JacksonDialogCallback<BaseResponse<PurchaseData>>(baseContext, true) {
                    ...
                    override fun onSuccess(response: Response<BaseResponse<PurchaseData>>) {
                        ...
                        member_buy.text = data.purchasingDescribe
                        member_count.text = data.purchasingNum
    ...
    fun getMasterList(id: String) {
        MobclickAgent.onEvent(this,"cg_det_contact_click")
    ...
    override fun onResume() {
        super.onResume()
        MobclickAgent.onPageStart("采购详情")
    }

    override fun onPause() {
        super.onPause()
        MobclickAgent.onPageEnd("采购详情")
    }
}
