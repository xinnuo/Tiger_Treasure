...
public abstract class StringDialogUncheckCallback extends StringCallback {

    private MProgressDialog mMProgressDialog;
    private Activity activity;
    private boolean isVisible = true;

    public StringDialogUncheckCallback(Activity activity) {
        this(activity, true);
    }

    public StringDialogUncheckCallback(Activity activity, boolean isVisible) {
    ...
    public abstract void onSuccessResponse(Response<String> response);
